...
STATIC_MARKET_ROWS = [
    # CNStock (curated A-share hotlist — major blue chips + 沪深300/科创板 leaders)
    SymbolMasterRow("CNStock", "600519", "贵州茅台", "SSE", "CNY"),
    SymbolMasterRow("CNStock", "601318", "中国平安", "SSE", "CNY"),
    SymbolMasterRow("CNStock", "600036", "招商银行", "SSE", "CNY"),
    SymbolMasterRow("CNStock", "601398", "工商银行", "SSE", "CNY"),
    SymbolMasterRow("CNStock", "601939", "建设银行", "SSE", "CNY"),
    SymbolMasterRow("CNStock", "600276", "恒瑞医药", "SSE", "CNY"),
    SymbolMasterRow("CNStock", "601012", "隆基绿能", "SSE", "CNY"),
    SymbolMasterRow("CNStock", "600030", "中信证券", "SSE", "CNY"),
    SymbolMasterRow("CNStock", "601166", "兴业银行", "SSE", "CNY"),
    SymbolMasterRow("CNStock", "600900", "长江电力", "SSE", "CNY"),
    SymbolMasterRow("CNStock", "000001", "平安银行", "SZSE", "CNY"),
    SymbolMasterRow("CNStock", "000002", "万科A", "SZSE", "CNY"),
    SymbolMasterRow("CNStock", "000333", "美的集团", "SZSE", "CNY"),
    SymbolMasterRow("CNStock", "000858", "五粮液", "SZSE", "CNY"),
    SymbolMasterRow("CNStock", "000651", "格力电器", "SZSE", "CNY"),
    SymbolMasterRow("CNStock", "300750", "宁德时代", "SZSE", "CNY"),
    SymbolMasterRow("CNStock", "300059", "东方财富", "SZSE", "CNY"),
    SymbolMasterRow("CNStock", "002594", "比亚迪", "SZSE", "CNY"),
    SymbolMasterRow("CNStock", "002475", "立讯精密", "SZSE", "CNY"),
    SymbolMasterRow("CNStock", "002714", "牧原股份", "SZSE", "CNY"),
    SymbolMasterRow("CNStock", "688981", "中芯国际", "SSE", "CNY"),
    SymbolMasterRow("CNStock", "688041", "海光信息", "SSE", "CNY"),
    SymbolMasterRow("CNStock", "688256", "寒武纪", "SSE", "CNY"),
    # HKStock (恒生指数 + 科技指数 leaders; 海外投资者最熟悉的港股权重)
    SymbolMasterRow("HKStock", "00700", "腾讯控股", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "09988", "阿里巴巴-W", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "03690", "美团-W", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "01211", "比亚迪股份", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "01810", "小米集团-W", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "09618", "京东集团-SW", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "09999", "网易-S", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "01024", "快手-W", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "02318", "中国平安", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "00939", "建设银行", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "01398", "工商银行", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "00388", "香港交易所", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "00005", "汇丰控股", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "00941", "中国移动", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "00883", "中国海洋石油", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "02628", "中国人寿", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "02313", "申洲国际", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "00016", "新鸿基地产", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "00027", "银河娱乐", "HKEX", "HKD"),
    SymbolMasterRow("HKStock", "09961", "携程集团-S", "HKEX", "HKD"),
